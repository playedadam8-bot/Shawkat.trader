...
def generate_vision_signal(api_key: str, image_bytes: bytes):
    ...
    - "expiry" must be explicitly given as a duration in minutes (e.g., "1 Minute", "2 Minutes", "3 Minutes", "4 Minutes", "5 Minutes", etc.) based on your analysis. NEVER return a clock time like 14:45.
    """
